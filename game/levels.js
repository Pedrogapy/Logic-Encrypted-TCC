...
/** Definições (1 página por nível) */
export const LEVELS = [
  { // Sala 1 — tutorial simples
    ...
    pages:[{x:190,y:400,key:"variaveis"}] // UMA página
  },
  { // Sala 2 — Módulo (%)
    ...
    pages:[{x:400,y:420,key:"modulo"}] // UMA página
  }
];
...
export function buildLevel(def){
  ...
  const entities = [];
  // paredes sólidas “invisíveis” (já desenhadas pelo mapa)
